...
RSpec.describe ProjectsController, :type => :controller do
  ...
  describe "POST 'Create'" do
    context "when the user is not logged in" do
      it "redirects" do
        expect {
          post :create, params: { project: {name: "Test", description: "Testing description."} }
    ...
    context "when the user is logged in" do
      ...
      it "can set the urls properly" do
        post :create, params: { project: { name: "Test", description: "Testing description.", url_types: ["Code Repository", "Website"], urls: ["1", "2"] } }
        expect(Project.last.urls).to eq([["Code Repository", "1"], ["Website", "2"]])
      end

      it "can set tags" do
        post :create, params: { project: { name: "Test", description: "X", tag_list: "hi, test" } }
  ...
  describe "POST 'update'" do
    ...
    context "when user is not logged in" do
      it "does not update a project" do
        post :update, params: { id: project1.id, project: project_params }
        project1.reload
    ...
    context "when the user is a member of that project" do
      ...
      it "can set the urls properly" do
        ...
        expect {
          post :update, params: { id: project1.id, project: { url_types: ["Code Repository", "Website"], urls: ["1", "2"] } }
  ...
  describe "POST 'destroy'" do
    ...
    context "when user is not logged in" do
      it "redirects" do
        post :destroy, params: { id: project1.id }
  ...
  describe "GET contribute" do
    ...
    it "adds me as a contributor" do
      expect {
        get :contribute, params: { id: project1.id }
  ...
  describe "GET uncontribute" do
    ...
    it "remove me as a contributor" do
      expect {
        get :uncontribute, params: { id: project1.id }
